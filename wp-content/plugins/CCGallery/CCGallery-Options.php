...
<div class="wrap">
    ...
    <?php
        if( isset( $_POST['save'] ) ) {
            ...
            if( !isset($error) ) {
               ...
               echo '<div class="error" id="message"><p></p></div>';
            }
    ...
    <a class="manager-page button-secondary" href="<?php echo esc_url( add_query_arg( array( 'page' => 'ccgallery_manager' ), admin_url( 'admin.php' ) ) );?>">Gallery Manager</a>
    ...
    <form id="ccgallery-settings" method="post" action="">
        ...
        <table class="form-table">
            ...
            <tr valign="top">
                ...
                <td>
                    <input type="checkbox" name="hideCoverflow" id="hideCoverflow" value="true" <?php isset($formFields['hideCoverflow']) ? checked('true', $formFields['hideCoverflow']) : checked('true', false);?> />
            ...
            <tr valign="top">
                ...
                <td>
                    <input type="checkbox" name="hideThumbnails" id="hideThumbnails" value="true" <?php isset($formFields['hideThumbnails']) ? checked('true', $formFields['hideThumbnails']) : checked('true', false);?> />
            ...
            <tr valign="top">
                ...
                <td>
                    <input type="checkbox" name="hideCoverflowList" id="hideCoverflowList" value="true" <?php isset($formFields['hideCoverflowList']) ? checked('true', $formFields['hideCoverflowList']) :  checked('true', false);?> />
